...
public:
    ...
    static Ref<GDGDK_XAsyncBlock> add_user_async(BitField<GDKXUserAddOptions::Enum> options);
    ...
    Ref<GDGDK_XAsyncBlock> get_gamer_picture_async(GDKXUserGamerPictureSize::Enum size) const;
    ...
    Ref<GDGDK_XAsyncBlock> resolve_privilege_with_ui_async(BitField<GDKXUserPrivilegeOptions::Enum> options, GDKXUserPrivilege::Enum privilege) const;
    Ref<GDGDK_XAsyncBlock> get_token_and_signature_async(BitField<GDKXUserGetTokenAndSignatureOptions::Enum> options,
        const String& method, const String& url, const TypedDictionary<String, String>& headers, const PackedByteArray& body) const;
    
    Ref<GDGDK_XAsyncBlock> resolve_issue_with_ui_async(const String& url = "") const;
    ...
    Ref<GDGDK_XAsyncBlock> find_controller_for_user_with_ui_async() const;
